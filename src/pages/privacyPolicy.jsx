        ...
        <div className="w-full min-h-screen bg-primary text-gray-300 relative overflow-hidden py-20 px-6">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-16">
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold text-white mt-4 tracking-tight">Privacy Policy</h1>
                ...
                <div className="glass-card p-8 sm:p-12 border border-white/8 backdrop-blur-md shadow-2xl flex flex-col gap-10">
                    <p className="text-sm md:text-base text-gray-400 leading-relaxed font-light">
                        At <span className="text-white font-medium">IONIX Computers</span>, we value your privacy and security. This Privacy Policy details how we handle, protect, and process user data across our platform. By accessing our services, you consent to the practices described in this document.
                    </p>
                    ...
                    <div className="border-t border-white/5 pt-8 mt-4 text-xs text-gray-500 leading-relaxed font-light">
                        If you have questions regarding this policy or wish to request the deletion of your account and personal data, please reach out to our legal officer team at <a href="mailto:support@ionixcomputers.lk" className="text-accent hover:underline">support@ionixcomputers.lk</a>.
                    </div>
                </div>
            </div>
        </div>
